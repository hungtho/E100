...
set PROJECT_FOLDER_NAME=E100

rem 	@ Project folder path
cd D:\07_Working

rem 	@ Back-up path
set BACKUP_PATH=D:\01_Project\2019-03_SYMC_E100_LDC\02_Design\01_Src\
...
bz.exe c -p:%PASSWORD% %BACKUP_PATH%%PROJECT_FOLDER_NAME%_%BACKUP_DATE%%BACKUP_TIME%.ZIP %PROJECT_FOLDER_NAME%  
goto CONTINUE
