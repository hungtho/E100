...
/* ##V_CFG_MANAGEMENT ##CQProject : FblKbApi_FrameNv_Symc CQComponent : Implementation */
#define FBLKBAPI_FRAMENV_SYMC_VERSION             0x0200u
#define FBLKBAPI_FRAMENV_SYMC_RELEASE_VERSION     0x00u
