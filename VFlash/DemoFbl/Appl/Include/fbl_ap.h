...
#define FBLKBAPI_VERSION                           0x0183u
...
/* ##V_CFG_MANAGEMENT ##CQProject : FblKbApi_Symc CQComponent : Implementation */
#define FBLKBAPI_SYMC_VERSION                    0x0201u
#define FBLKBAPI_SYMC_RELEASE_VERSION            0x00u

/* ##V_CFG_MANAGEMENT ##CQProject : FblKbApi_Frame_Symc CQComponent : Implementation */
#define FBLKBAPI_FRAME_SYMC_VERSION               0x0200u
#define FBLKBAPI_FRAME_SYMC_RELEASE_VERSION       0x00u
...
/* Fingerprint status handling */
# define kFblDiagTesterSerialNoValid      FBL_BIT0
# define kFblDiagProgDateValid            FBL_BIT1
# define kFblDiagFpValid                  (kFblDiagProgDateValid | kFblDiagTesterSerialNoValid)

# define SetTesterSerialNoValid()         (fpStatus |= kFblDiagTesterSerialNoValid)
# define SetProgDateValid()               (fpStatus |= kFblDiagProgDateValid)
# define GetFpValid()                     ((fpStatus & kFblDiagFpValid) == kFblDiagFpValid)
...
#endif
V_MEMRAM0 extern V_MEMRAM1 vuint8 V_MEMRAM2 fpStatus;
