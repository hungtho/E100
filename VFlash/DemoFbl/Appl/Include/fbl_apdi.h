 ...
 *  02.01.00   2018-02-08  CB     ESCAN00098299    TesterSerialNumber length changed to 8 bytes
 **********************************************************************************************************************/
...
/* ##V_CFG_MANAGEMENT ##CQProject : FblKbApi_FrameDiag_Symc CQComponent : Implementation */
#define FBLKBAPI_FRAMEDIAG_SYMC_VERSION           0x0201u
#define FBLKBAPI_FRAMEDIAG_SYMC_RELEASE_VERSION   0x00u

/***********************************************************************************************************************
*  DEFINES
**********************************************************************************************************************/

#define kFblDiagDidSymcPartNumber                        0xF187u
#define kFblDiagSizeSymcPartNumber                       10u

#define kFblDiagDidSymcSoftwareVersion                   0xF189u
#define kFblDiagSizeSymcSoftwareVersion                  2u

#define kFblDiagDidSystemSupplierCode                    0xF18Au
#define kFblDiagSizeSystemSupplierCode                   5u

#define kFblDiagDidTesterSerialNumber                    0xF198u
#define kFblDiagSizeTesterSerialNumber                   8u

#define kFblDiagDidProgrammingDate                       0xF199u
#define kFblDiagSizeProgrammingDate                      3u

#define kFblDiagDidProgrammingIdentificationInformation  0xF1A1u
#define kFblDiagSizeProgrammingIdentificationInformation 6u

/* Application header structure */

#define kApplSizeSwInfo                                  (kFblDiagSizeSymcPartNumber+    \
                                                         kFblDiagSizeSymcSoftwareVersion+ \
                                                         kFblDiagSizeSystemSupplierCode)

#define kApplSizeSupplierSwVersion                       3u      /**< Size of Compatibility software version  */
#define kApplSizeNumberHwCompatibilityEntries            1u      /**< Size of Number of hardware compatibility field entries */
#define kApplSizeSupplierHwVersion                       2u      /**< Size of Compatibility hardware version  */

/* Offsets in application header structure */
#define kApplHdrOffsetSymcPartNumber                     0x00u
#define kApplHdrOffsetSymcSoftwareVersion                kApplHdrOffsetSymcPartNumber + kFblDiagSizeSymcPartNumber
#define kApplHdrOffsetSystemSupplierCode                 kApplHdrOffsetSymcSoftwareVersion + kFblDiagSizeSymcSoftwareVersion
#define kApplHdrOffsetSupplierSwVersion                  kApplHdrOffsetSystemSupplierCode + kFblDiagSizeSystemSupplierCode
#define kApplHdrOffsetNumberHwCompatibilityEntries       kApplHdrOffsetSupplierSwVersion + kApplSizeSupplierSwVersion
#define kApplHdrOffsetSupplierHwVersion                  kApplHdrOffsetNumberHwCompatibilityEntries + kApplSizeNumberHwCompatibilityEntries
