...
#if (defined (DESC_ENABLE_SA_STATIC_SEED) && (kDescNumStateSecurityAccess > 2)) || \
    defined (DESC_ENABLE_MULTIPLE_SEED_LENGTH)
# define DESC_ENABLE_SA_MULTI_SEED_OBJ
#else
# define DESC_DISABLE_SA_MULTI_SEED_OBJ
#endif
...
#define DESC_IMPLEMENTATION_MAGIC_NUMBER                             13582
...
#define kDescNumSvcHeadConstGapBits                                  5
...
/* SvcHead table size. */
#define kDescSvcHeadNumItems                                         10
/* SvcInst table size. */
#define kDescSvcInstNumItems                                         21
/* SvcInstHeadEx table size. */
#define kDescSvcInstHeadExtNumItems                                  19
/* Context modes */
...
#define DESC_ADD_SUPPRESSED_FUNC_NRC                                 case 0x7f: case 0x7e:
...
/* Security access key length */
#define kDescSecurityAccessKeyLength                                 (vuint8) 4

/* Must not be greater 255 since a byte counter is used */
/* todo: check this setting in the generator!!!*/

#define kDescNumPids                                                 8
...
static void DESC_API_CALLBACK_TYPE DescOemStartSessionSafety_System_Diagnostic_Session(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescReadDataByIdentifier(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemGetrequestSeed_ECU_Coding_Level_1(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemSendsendKey_ECU_Coding_Level_1(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemGetrequestSeed_ECU_Programming_Level_3(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemSendsendKey_ECU_Programming_Level_3(DescMsgContext* pMsgContext);
...
/* Utility */
#if defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)  || \
    defined (DESC_ENABLE_MULTIPLE_KEY_LENGTH) || \
    defined (DESC_ENABLE_SA_MULTI_SEED_OBJ) || \
    defined (DESC_ENABLE_MULTI_CHALLENGE_SECURITY) || \
    defined (DESC_ENABLE_DELAY_TIME_LEVEL_SPECIFIC)
...
#if defined (DESC_ENABLE_SA_TIMER_AND_COUNTER)
static vuint8                     g_descSecureNrOfAttempts[kDescNumStateSecurityAccess-1];
static vuint16                    g_descSecureTimer[kDescNumStateSecurityAccess-1];
#endif

#if defined (DESC_ENABLE_SA_STATIC_SEED)
static vuint8                     g_descSeedStored[kDescNumStateSecurityAccess-1];
#endif
...
{
  { { 0x0F, 0x06, 0x00 }, { 0x01, 0x01, 0x00 } }, 
  { { 0x06, 0x06, 0x00 }, { 0x02, 0x01, 0x00 } }, 
  { { 0x05, 0x06, 0x00 }, { 0x04, 0x01, 0x00 } }, 
  { { 0x0C, 0x06, 0x00 }, { 0x08, 0x01, 0x00 } }, 
...
V_MEMROM0 static V_MEMROM1 DescMsgItem V_MEMROM2 g_descSidMap[kDescSvcIdMapSize] = 
{
  ...
  0xFF, 0xFF, 0x04, 0xFF, 0xFF, 0xFF, 0xFF, 0x05, 0x06, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
...
{
  { 0x01, 1, 1, 1, 1, 1, 0x00, { 0x0F, 0x07, 0x00 },  2,  0,  0 } /* $10 */, 
  { 0x01, 1, 1, 1, 1, 1, 0x00, { 0x06, 0x07, 0x00 },  2,  4,  4 } /* $11 */, 
  { 0x01, 0, 0, 0, 1, 0, 0x00, { 0x04, 0x07, 0x00 },  4,  5,  5 } /* $14 */, 
  { 0x01, 1, 1, 1, 1, 1, 0x00, { 0x05, 0x07, 0x00 },  2,  6,  5 } /* $19 */, 
  { 0x01, 0, 0, 0, 1, 0, 0x00, { 0x0F, 0x07, 0x00 },  1,  9,  8 } /* $22 */, 
  { 0x01, 1, 1, 1, 1, 1, 0x00, { 0x0E, 0x07, 0x00 },  2, 10,  8 } /* $27 */, 
  { 0x01, 1, 1, 1, 1, 1, 0x00, { 0x06, 0x07, 0x00 },  2, 14, 12 } /* $28 */, 
  { 0x01, 1, 1, 1, 1, 1, 0x00, { 0x0F, 0x07, 0x00 },  2, 18, 16 } /* $3E */, 

  { 0x01, 1, 1, 1, 1, 1, 0x00, { 0x06, 0x07, 0x00 },  2, 19, 17 } /* $85 */, 
  { 0x00, 0, 0, 0, 1, 0, 0x00, { 0x00, 0x00, 0x00 },  1, 21, 19 } /* $FF */
};
...
{
  {   2, { 0x0F, 0x07, 0x00 },                      0,    0, DescOemStartSessionDefault } /* $10 $1 */, 
  {   2, { 0x06, 0x07, 0x00 },                      1,    0, DescOemStartSessionProgramming } /* $10 $2 */, 
  {   2, { 0x05, 0x07, 0x00 },                      2,    0, DescOemStartSessionExtended } /* $10 $3 */, 
  {   2, { 0x0C, 0x07, 0x00 },                      3,    0, DescOemStartSessionSafety_System_Diagnostic_Session } /* $10 $4 */, 
  {   2, { 0x06, 0x07, 0x00 },                      4,    0, ApplDescEcuResetHard } /* $11 $1 */, 
  {   0, { 0x04, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescClearDiagInfo } /* $14 */, 
  {   3, { 0x05, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescReadDtcRNODTCBSM } /* $19 $1 */, 
  {   3, { 0x05, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescReadDtcRDTCBSM } /* $19 $2 */, 

  {   2, { 0x05, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescReadDtcRSUPDTC } /* $19 $A */, 
  {   0, { 0x0F, 0x07, 0x00 }, kDescStateNoTransition,    1, DescReadDataByIdentifier } /* $22 */, 
  {   2, { 0x0E, 0x03, 0x00 }, kDescStateNoTransition,    0, DescOemGetrequestSeed_ECU_Coding_Level_1 } /* $27 $1 */, 
  {   0, { 0x0E, 0x03, 0x00 },                      5,    0, DescOemSendsendKey_ECU_Coding_Level_1 } /* $27 $2 */, 
  {   2, { 0x0E, 0x05, 0x00 }, kDescStateNoTransition,    0, DescOemGetrequestSeed_ECU_Programming_Level_3 } /* $27 $5 */, 
  {   0, { 0x0E, 0x05, 0x00 },                      6,    0, DescOemSendsendKey_ECU_Programming_Level_3 } /* $27 $6 */, 
  {   3, { 0x06, 0x07, 0x00 }, kDescStateNoTransition,    2, DescOemCommCtrlEnableRxEnableTx } /* $28 $0 */, 
  {   3, { 0x06, 0x07, 0x00 }, kDescStateNoTransition,    2, DescOemCommCtrlEnableRxDisableTx } /* $28 $1 */, 

  {   3, { 0x06, 0x07, 0x00 }, kDescStateNoTransition,    2, DescOemCommCtrlDisableRxEnableTx } /* $28 $2 */, 
  {   3, { 0x06, 0x07, 0x00 }, kDescStateNoTransition,    2, DescOemCommCtrlDisableRxDisableTx } /* $28 $3 */, 
  {   2, { 0x0F, 0x07, 0x00 }, kDescStateNoTransition,    0, DescOemProcessTesterPresent } /* $3E $0 */, 
  {   2, { 0x06, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescControlDtcSettingEnable } /* $85 $1 */, 
  {   2, { 0x06, 0x07, 0x00 }, kDescStateNoTransition,    0, ApplDescControlDtcSettingDisable } /* $85 $2 */
};
...
{
  0x01, 0x02, 0x03, 0x04 /* $10 */, 
  0x01 /* $11 */, 
  0x01, 0x02, 0x0A /* $19 */, 
  0x01, 0x02, 0x05, 0x06 /* $27 */, 
...
{
  { 0xEF01,    6, { { 0x05, 0x07, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidECU_Status_Message }, 
  { 0xF187,   10, { { 0x0F, 0x07, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidSYMC_Part_Number }, 
  { 0xF189,    2, { { 0x0D, 0x07, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidSYMC_Software_version }, 
  { 0xF18A,    5, { { 0x0F, 0x07, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidSystem_supplier }, 
  { 0xF198,    8, { { 0x0F, 0x07, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidRepair_Shop_Code_or_Tester_Serial_Number }, 
  { 0xF199,    3, { { 0x0F, 0x07, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidProgramming_Date }, 
  { 0xF1A0,    2, { { 0x0D, 0x07, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidDiagnostic_Information }, 
  { 0xF1A1,    0, { { 0x0D, 0x07, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidProgramming_Identification_Information }
};
...
# define DescGetSeedLength(levelIndex)                               (g_descSeedLength[levelIndex])
#else
# define DescGetSeedLength(levelIndex)                               (kDescSecurityAccessSeedLength)
#endif

#if defined (DESC_ENABLE_MULTIPLE_KEY_LENGTH)
# define DescGetKeyLength(levelIndex)                                (g_descKeyLength[levelIndex])
#else
# define DescGetKeyLength(levelIndex)                                (kDescSecurityAccessKeyLength)
#endif

#if defined (DESC_ENABLE_SA_TIMER_AND_COUNTER)
# if defined (DESC_ENABLE_ATTEMPT_COUNTER_LEVEL_SPECIFIC)
#  define DescGetSACounterValue(index)                               (g_descAttemptCounterValue[index])
# else
#  define DescGetSACounterValue(index)                               (kDescMaxNumberOfAttempts)
# endif

# if defined (DESC_ENABLE_POWERON_TIME_LEVEL_SPECIFIC)
#  define DescGetSAPwrOnTimeValue(index)                             (g_descPwrOnTimeValue[index])
# else
#  define DescGetSAPwrOnTimeValue(index)                             (kDescPowerOnSecureTimer)
# endif

# if defined (DESC_ENABLE_DELAY_TIME_LEVEL_SPECIFIC)
#  define DescGetSADelayTimeValue(index)                             (g_descDelayTimerValue[index])
# else
#  define DescGetSADelayTimeValue(index)                             (kDescSecureTimer)
# endif
#endif

#if defined (DESC_ENABLE_SA_STATIC_SEED)
# define DescGetSASeedBuffer(index)                                  (g_descSASeedBufferTable[index])
#else
/* shall not be used */
#endif
...
#if defined (DESC_ENABLE_SA_STATIC_SEED)
# define DescIsSAStoredSeed(index)                                   (g_descSeedStored[index] != kDescFalse)
# define DescSetSAStoredSeed(index, value)                           (g_descSeedStored[index] = (value))
#endif

#if defined (DESC_ENABLE_SA_MULTI_SEED_OBJ)
# define DescGetSeedObjIdxOfLevel(securityLevel)                     (DescGetLevelIdxOfState(securityLevel))
#else
# define DescGetSeedObjIdxOfLevel(securityLevel)                     ((vuint8_least)0)
#endif

#if defined (DESC_ENABLE_MULTIPLE_KEY_LENGTH)
# define DescGetKeyObjIdxOfLevel(securityLevel)                      (DescGetLevelIdxOfState(securityLevel))
#else
# define DescGetKeyObjIdxOfLevel(securityLevel)                      ((vuint8_least)0)
#endif

#if defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)
# define DescGetInstanceIdxOfLevel(securityLevel)                    (DescGetLevelIdxOfState(securityLevel))
#else
# define DescGetInstanceIdxOfLevel(securityLevel)                    ((vuint8_least)0)
#endif

#if defined (DESC_ENABLE_DELAY_TIME_LEVEL_SPECIFIC)
# define DescGetDelayTimeIdxOfLevel(securityLevel)                   (DescGetLevelIdxOfState(securityLevel))
#else
# define DescGetDelayTimeIdxOfLevel(securityLevel)                   ((vuint8_least)0)
#endif

#if defined (DESC_ENABLE_SA_TIMER_AND_COUNTER)
# define DescSetSADelayTimer(index, value)                           (g_descSecureTimer[index] = (value))
# define DescGetSADelayTimer(index)                                  (g_descSecureTimer[index])
# define DescDecrementSADelayTimer(index)                            (g_descSecureTimer[index]--)
# define DescIncrementSAAttemptCounter(index)                        (g_descSecureNrOfAttempts[index]++)
# define DescSetSAAttemptCounter(index, value)                       (g_descSecureNrOfAttempts[index] = (value))
# define DescGetSAAttemptCounter(index)                              (g_descSecureNrOfAttempts[index])
#endif

#if !defined(DescOemOnInvalidRequest)
# define DescOemOnInvalidRequest(iContext)                           (DescOemOnInvalidReq_27(DESC_CONTEXT_PARAM_WRAPPER_ONLY(iContext)))
#endif
...
static void DescDispatcher(DESC_CONTEXT_FORMAL_PARAM_DEF_ONLY)
{
  ...
  /* Set default response on request type (phys - yes, func - yes) */
  g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].msgAddInfo.resOnReq = kDescResOnAllReq;
  ...
  ApplDescManufacturerIndication(DESC_CONTEXT_PARAM_FIRST msg[0], &msg[1], (DescMsgLen)(g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].reqDataLen - 1) ,(vuint8) g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].msgAddInfo.reqType, &g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].busInfo);
  if (g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] == kDescNrcNone)
#endif
  {
    /*---------------------------------------------*/
    ...
    if(g_descCurReqSvc[DESC_CONTEXT_PARAM_VALUE] < kDescInvalidSvcHandle)
    {
      ...
      g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] = DescCheckState(&(refDescSvcHead->checkState));
      ...
      {
#if defined (DESC_ENABLE_SUPPLIER_CALLBACKS)
        ApplDescSupplierIndication(DESC_CONTEXT_PARAM_FIRST  msg[0],  &msg[1], (g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].reqDataLen-1) ,(vuint8) g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].msgAddInfo.reqType, &g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].busInfo);
        g_descContextCtrl[DESC_CONTEXT_PARAM_VALUE].isSupplPost = 1;
...
# endif
...
#endif
        }/*SuppleirIndication check, NRC already set*/
      } /*check state on SID level*/
      else
      {
        /* EXAMPLE: Additional activities may be necessary */
        if(g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] ==  kDescNrcSubfunctionNotSupportedInActiveSession)
  ...
  }/*ManufacturerIndication check, NRC already set*/
...
/*  ********************************************************************************
 * Function name:DescOemStartSessionSafety_System_Diagnostic_Session
 * Description:Processes the session change request, parametrizing the common processing
 * function.
 * Returns:  nothing
 * Parameter(s):
...
static void DESC_API_CALLBACK_TYPE DescOemStartSessionSafety_System_Diagnostic_Session(DescMsgContext* pMsgContext)
{
  DescOemPrepareSessionControl(pMsgContext, kDescStateSessionSafetySystem);
}


/*  ********************************************************************************
 * Function name:DescOemGetrequestSeed_ECU_Coding_Level_1
...
/*  ********************************************************************************
 * Function name:DescOemSendsendKey_ECU_Coding_Level_1
...
/*  ********************************************************************************
 * Function name:DescOemGetrequestSeed_ECU_Programming_Level_3
 * Description:Manages the security get seed function.
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext:
...
static void DESC_API_CALLBACK_TYPE DescOemGetrequestSeed_ECU_Programming_Level_3(DescMsgContext* pMsgContext)
{
  DescOemSecuritySeed(pMsgContext, kDescStateSecurityAccessECU_Programming_Level_3);
}


/*  ********************************************************************************
 * Function name:DescOemSendsendKey_ECU_Programming_Level_3
 * Description:Manages the security send key function.
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext:
...
static void DESC_API_CALLBACK_TYPE DescOemSendsendKey_ECU_Programming_Level_3(DescMsgContext* pMsgContext)
{
  DescOemSecurityKey(pMsgContext, kDescStateSecurityAccessECU_Programming_Level_3);
}
...
/*******************************************************************************
* Function name:  DescOemOnInvalidReq_27
* Description:    Special security state handling on invalid request
* Returns:        -
* Parameters:     iContext - Context parameter value of the active context
* Called by:         DescDispatcher
* Particularitie(s) and limitation(s): The function is called in case a general
*       format check has failed. The state should not be reset in case the SID
*       is not supported in active session/security state. The function will be also
*       called in that case, but because the SID is not supported in the active state
*       the "awaitKey" state will never be true during that active state (because
*       all requests to change that state are forbidden in that state).
*
*******************************************************************************/
static void DescOemOnInvalidReq_27(DESC_CONTEXT_FORMAL_PARAM_DEF_ONLY)
{
...
static void DescSecurityOnceInitPowerOn(void)
{
# if defined (DESC_ENABLE_SA_STATIC_SEED)|| defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)
  vuint8_least i = 0;
  for( ; i < (kDescNumStateSecurityAccess-1); i++)

  {
#  if defined (DESC_ENABLE_SA_STATIC_SEED)
    DescSetSAStoredSeed(i, kDescFalse);
#  endif
#  if defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)
    DescSetSADelayTimer(i, DescGetSAPwrOnTimeValue(i));
    DescSetSAAttemptCounter(i, 0);
#  endif
  }
# endif /*(DESC_ENABLE_SA_STATIC_SEED)|| defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)*/

# if defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)
/* already initialized */
# else
  DescSetSADelayTimer(0, DescGetSAPwrOnTimeValue(0));
  DescSetSAAttemptCounter(0, 0);
# endif

/*Set PowerOn timer values*/
...
{
  vuint8_least i = 0;
  /*iterate over all timer for all levels*/
# if defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)
  for(; i < (kDescNumStateSecurityAccess-1); i++)
# endif
  {
   /*timer active?*/
    if(DescGetSADelayTimer(i) != 0)
    {
      DescDecrementSADelayTimer(i);
...
#   if defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)
           DescStateGroupsecurityLevel=2<<i;
#   endif
        ApplDescSecurityAccessOnAttCntrChanged(DESC_LEVEL_CONTEXT_PARAM_VALUE_SET_FIRST kDescSecAccAttCtrChgOnTimeExpire, 0);
#  endif
        DescSetSAAttemptCounter(i, 0);
      }
# endif
 ...
 * Parameter(s): - securityLevel: when level specific counters are used
 * Particularitie(s) and limitation(s):
 ******************************************************************************** */
vuint8 DescGetAttemptCounterValue(DESC_LEVEL_FORMAL_PARAM_DEF_ONLY)
{
  return DescGetSAAttemptCounter(DescGetInstanceIdxOfLevel(DESC_LEVEL_CONTEXT_PARAM_VALUE));
}
#endif
 ...
 * Returns:  -
 * Parameter(s): - securityLevel: when level specific counters are used
 *               - value: value of the attempt counter
 * Particularitie(s) and limitation(s):
 ******************************************************************************** */
void DescSetAttemptCounterValue(DESC_LEVEL_FORMAL_PARAM_DEF_FIRST vuint8 value)
{
# if defined (DESC_ENABLE_REPORT_ATT_CNTR_STATE)
  ApplDescSecurityAccessOnAttCntrChanged(DESC_LEVEL_CONTEXT_PARAM_VALUE_SET_FIRST kDescSecAccAttCtrChgOnApplRequest, value);
# endif
  DescSetSAAttemptCounter(DescGetInstanceIdxOfLevel(DESC_LEVEL_CONTEXT_PARAM_VALUE), value);
}
#endif

#if defined (DESC_ENABLE_START_SA_TIMER_EXTERN) &&  defined(DESC_ENABLE_SA_TIMER_AND_COUNTER)
/* ********************************************************************************
 * Function name:DescStartSecureTimer
 * Description: Activate brute-force inhibition
 * Returns:  -
 * Parameter(s): - securityLevel: when level specific timers are used
 * Particularitie(s) and limitation(s):
 ******************************************************************************** */
void  DescStartSecureTimer(DESC_LEVEL_FORMAL_PARAM_DEF_ONLY)
{
  vuint8_least index = DescGetInstanceIdxOfLevel(DESC_LEVEL_CONTEXT_PARAM_VALUE);
  DescSetSADelayTimer(index, DescGetSADelayTimeValue(index));
}
#endif
 ...
 * Returns:  -
 * Parameter(s): - securityLevel: when level specific timers are used
 *               - value: value of the timer in ms
 * Particularitie(s) and limitation(s):
 ******************************************************************************** */
void  DescStartSecureTimerValue(DESC_LEVEL_FORMAL_PARAM_DEF_FIRST vuint16 value)
{
  DescSetSADelayTimer(DescGetInstanceIdxOfLevel(DESC_LEVEL_CONTEXT_PARAM_VALUE), DescGetTicksOfMs(value));
}
#endif
...
static void DescOemSecuritySeed(DescMsgContext* pMsgContext, DescStateGroup requestedSecurityLevel)
{
...
#if defined (DESC_ENABLE_SA_STATIC_SEED) || defined ( DESC_ENABLE_MULTIPLE_SEED_LENGTH)
  vuint8_least securitySeedObjIndex = DescGetSeedObjIdxOfLevel(requestedSecurityLevel);
#endif
#if defined (DESC_ENABLE_SA_TIMER_AND_COUNTER)
  vuint8_least securityInstanceIndex = DescGetInstanceIdxOfLevel(requestedSecurityLevel);
#endif

  g_descSecurityAccessContext.dataLen       = DescGetSeedLength(securitySeedObjIndex);
  /* store seed in correct buffer if needed => GetBuffer*/
#if defined (DESC_ENABLE_SA_STATIC_SEED)
  g_descSecurityAccessContext.dataPtr       = (DescMsg)((DescGetSASeedBuffer(securitySeedObjIndex) == V_NULL)? pMsgContext->resData : DescGetSASeedBuffer(securitySeedObjIndex));
#else
...
#if defined (DESC_ENABLE_SA_TIMER_AND_COUNTER)
  /*check timer*/
  if(DescGetSADelayTimer(securityInstanceIndex) != 0)
  {
...
#endif
  {
    ...
    else
    {
...
#if defined (DESC_ENABLE_SA_STATIC_SEED)
      /* Call application if Seed needed */
      if(DescIsSAStoredSeed(securitySeedObjIndex))
      {
        /* Finalize the request */
        DescSecurityAccessSeedReady(DESC_CONTEXT_PARAM_WRAPPER_ONLY(pMsgContext->iContext));
      }
      ...
      {
#if defined (DESC_ENABLE_SA_STATIC_SEED)
        if(DescGetSASeedBuffer(securitySeedObjIndex) != V_NULL)
        {
          DescSetSAStoredSeed(securitySeedObjIndex, kDescTrue);
        }
#endif
#if defined (DESC_ENABLE_PERMANENT_MAINHANDLER_MULTICALL)
...
#if defined(DESC_ENABLE_SA_STATIC_SEED)
    if(DescGetSASeedBuffer(DescGetSeedObjIdxOfLevel(g_descSecurityAccessContext.securityLevel)) != V_NULL)
    {
      /* Copy the SEED (either the stored, newly generated or zero seed)  */
      DescMsgCopyRamToFarRam(g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].resData, g_descSecurityAccessContext.dataPtr, g_descSecurityAccessContext.dataLen);
    }
#endif
  }
  DescProcessingDone(DESC_CONTEXT_PARAM_ONLY);
...
static void DescOemSecurityKey(DescMsgContext* pMsgContext, DescStateGroup requestedSecurityLevel)
{
#if defined (DESC_ENABLE_REPORT_ATT_CNTR_STATE) && defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)
  DescStateGroup securityLevel = requestedSecurityLevel;
#endif
  if(g_descIsKeyAwaited != kDescFalse)
  {
#if defined (DESC_ENABLE_MULTIPLE_KEY_LENGTH)
    vuint8_least securityKeyObjIndex = DescGetKeyObjIdxOfLevel(requestedSecurityLevel);
#endif
#if defined (DESC_ENABLE_SA_TIMER_AND_COUNTER)
    vuint8_least securityInstanceIndex = DescGetInstanceIdxOfLevel(requestedSecurityLevel);
#endif
    ...
    {
      if(pMsgContext->reqDataLen == DescGetKeyLength(securityKeyObjIndex))
      {
        /*But first develop a new dispatcher concept*/
...
#if defined (DESC_ENABLE_SA_TIMER_AND_COUNTER)
# if defined (DESC_ENABLE_REPORT_ATT_CNTR_STATE)
        ApplDescSecurityAccessOnAttCntrChanged(DESC_LEVEL_CONTEXT_PARAM_VALUE_SET_FIRST kDescSecAccAttCtrChgOnKeyLengthInvalid, DescGetSAAttemptCounter(securityInstanceIndex)+1);
# endif
        DescIncrementSAAttemptCounter(securityInstanceIndex);
#endif
        /*raise false attempt counter*/
        g_descNegResCode[DESC_CONTEXT_PARAM_WRAPPER_INDEX(pMsgContext->iContext)] = kDescNrcInvalidFormat;
        /*finish processing*/
        DescProcessingDone(DESC_CONTEXT_PARAM_WRAPPER_ONLY(pMsgContext->iContext));
      }
    }
    else /*key for wrong level received*/
    {
#if defined (DESC_ENABLE_SA_TIMER_AND_COUNTER)
# if defined (DESC_ENABLE_REPORT_ATT_CNTR_STATE)
      ApplDescSecurityAccessOnAttCntrChanged(DESC_LEVEL_CONTEXT_PARAM_VALUE_SET_FIRST kDescSecAccAttCtrChgOnKeyWrongLevel, DescGetSAAttemptCounter(securityInstanceIndex)+1);
# endif
      DescIncrementSAAttemptCounter(securityInstanceIndex);
#endif
      /*raise false attempt counter*/
...
{
#if defined (DESC_ENABLE_REPORT_ATT_CNTR_STATE) && defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)
  DescStateGroup securityLevel = g_descSecurityAccessContext.securityLevel;
#endif
#if defined (DESC_ENABLE_SA_TIMER_AND_COUNTER)
  vuint8_least securityInstanceIndex = DescGetInstanceIdxOfLevel(g_descSecurityAccessContext.securityLevel);
#endif
  ...
  /*increment counter*/
# if defined (DESC_ENABLE_ATTEMPT_COUNTER_LEVEL_SPECIFIC)
      /*counter supported for current level?*/
      if(DescGetSACounterValue(securityInstanceIndex) != 0)
# endif
      {
        if(DescGetSAAttemptCounter(securityInstanceIndex) >=  DescGetSACounterValue(securityInstanceIndex)-1)
        {
          g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] = kDescNrcExceedNumOfAttempts;
          /*Start Timer*/
          DescSetSADelayTimer( securityInstanceIndex, DescGetSADelayTimeValue(DescGetDelayTimeIdxOfLevel(g_descSecurityAccessContext.securityLevel)) );
# if defined (DESC_ENABLE_REPORT_ATT_CNTR_STATE)
          ApplDescSecurityAccessOnAttCntrChanged(DESC_LEVEL_CONTEXT_PARAM_VALUE_SET_FIRST kDescSecAccAttCtrChgOnTooManyInvalidKeys, DescGetSAAttemptCounter(securityInstanceIndex)+1);
# endif
        }
# if defined (DESC_ENABLE_REPORT_ATT_CNTR_STATE)
        else
        {
          ApplDescSecurityAccessOnAttCntrChanged(DESC_LEVEL_CONTEXT_PARAM_VALUE_SET_FIRST kDescSecAccAttCtrChgOnInvalidKey, DescGetSAAttemptCounter(securityInstanceIndex)+1);
        }
# endif
        DescIncrementSAAttemptCounter(securityInstanceIndex);
      }
    ...
    else /*Key OK*/
    {
      ...
      /*Clear Counter*/
# if defined (DESC_ENABLE_REPORT_ATT_CNTR_STATE)
      ApplDescSecurityAccessOnAttCntrChanged(DESC_LEVEL_CONTEXT_PARAM_VALUE_SET_FIRST kDescSecAccAttCtrChgOnValidKey, 0);
# endif
      DescSetSAAttemptCounter(securityInstanceIndex, 0);
#endif
      /*Clear seed*/

#if defined (DESC_ENABLE_SA_STATIC_SEED)
      {
        vuint8_least securityIndex = DescGetSeedObjIdxOfLevel(g_descSecurityAccessContext.securityLevel);

        if(DescGetSASeedBuffer(securityIndex) != V_NULL)
        {
          DescSetSAStoredSeed(securityIndex, kDescFalse);
        }
      }
#endif
      /*transition is done via statemachine*/
    }
  }
  /*finish processing*/
  DescProcessingDone(DESC_CONTEXT_PARAM_ONLY);
