...
#define DESC_ENABLE_PROTOCOL_UDS2012
...
/* Do check addressing of request will not be supported. */
#define DESC_DISABLE_ADDR_METHOD_CHECK
/* Do check all state groups on SID level. will be supported. */
#define DESC_ENABLE_ALL_STATEGROUPS_SID_CHECK
/* Session check before format check will be supported. */
#define DESC_ENABLE_SESSION_FORMAT_STATE_CHECK
/* Send all Nrcs after a pending was sent will be supported. */
#define DESC_ENABLE_ALL_RES_AFTER_RCRRP
/* Handle DIDs not supported in current session as not supported will be supported. */
#define DESC_ENABLE_SKIP_PID_ON_WRONG_SESSION
/* Do send NRC for wrong session only if none of the requested PIDs are supported in the session. will be supported. */
#define DESC_ENABLE_PID_NRC_ALL_ON_WRONG_SESSION
...
/* PowerOn Delay is supported will not be supported. */
#define DESC_DISABLE_POWER_ON_DELAY
/* Counter and timer are level specific will not be supported. */
#define DESC_DISABLE_SA_LEVEL_SPECIFIC
/* Delay Time level specific will not be supported. */
#define DESC_DISABLE_DELAY_TIME_LEVEL_SPECIFIC
/* Power On Time level specific will not be supported. */
#define DESC_DISABLE_POWERON_TIME_LEVEL_SPECIFIC
/* Atempt Counter level specific will not be supported. */
#define DESC_DISABLE_ATTEMPT_COUNTER_LEVEL_SPECIFIC
/* On change attempt counter value notification will not be supported. */
#define DESC_DISABLE_REPORT_ATT_CNTR_STATE
/* Support Attempt Counter and delay will be supported. */
#define DESC_ENABLE_SA_TIMER_AND_COUNTER
...
/* Support static seed calculation will not be supported. */
#define DESC_DISABLE_SA_STATIC_SEED
/* Multiple seed length will not be supported. */
#define DESC_DISABLE_MULTIPLE_SEED_LENGTH
/* Multiple key length will not be supported. */
#define DESC_DISABLE_MULTIPLE_KEY_LENGTH
...
#define DESC_PUBLIC_INTERFACE_MAGIC_NUMBER                           13582
...
#define kDescPrimBufferLen                                           5000
...
#define kDescStateSessionSafetySystem                                ((DescStateGroup)0x08)
...
#define kDescStateSecurityAccessECU_Programming_Level_3              ((DescStateGroup)0x04)
...
#define kDescSecureTimer                                             1000
#define kDescPowerOnSecureTimer                                      0
#if defined (DESC_ENABLE_SA_LEVEL_SPECIFIC)
# define DESC_LEVEL_FORMAL_PARAM_DEF_ONLY                            DescStateGroup securityLevel
# define DESC_LEVEL_FORMAL_PARAM_DEF_FIRST                           DescStateGroup securityLevel,
# define DESC_LEVEL_CONTEXT_PARAM_VALUE                              securityLevel
# define DESC_LEVEL_CONTEXT_PARAM_VALUE_SET                          securityLevel
# define DESC_LEVEL_CONTEXT_PARAM_VALUE_SET_FIRST                    securityLevel,
#else
# define DESC_LEVEL_FORMAL_PARAM_DEF_ONLY                            void
# define DESC_LEVEL_FORMAL_PARAM_DEF_FIRST
# define DESC_LEVEL_CONTEXT_PARAM_VALUE                              ((vuint8)1)
# define DESC_LEVEL_CONTEXT_PARAM_VALUE_SET
# define DESC_LEVEL_CONTEXT_PARAM_VALUE_SET_FIRST
#endif
...
# define kDescSecAccAttCtrChgOnKeyLengthInvalid                      (DescSecAccAttCtrChgEvType)7
# define kDescSecAccAttCtrChgOnKeyWrongLevel                         (DescSecAccAttCtrChgEvType)8
